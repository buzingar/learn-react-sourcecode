...
function resolveDispatcher() {
  ...
  null === dispatcher ? reactProdInvariant("298") : void 0;
  return dispatcher;
}
var React = {
  Children: {
...
React.useCallback = function(callback, inputs) {
  return resolveDispatcher().useCallback(callback, inputs);
};
React.useContext = function(Context, observedBits) {
  return resolveDispatcher().useContext(Context, observedBits);
};
React.useEffect = function(create, inputs) {
  return resolveDispatcher().useEffect(create, inputs);
};
React.useImperativeMethods = function(ref, create, inputs) {
  return resolveDispatcher().useImperativeMethods(ref, create, inputs);
};
React.useLayoutEffect = function(create, inputs) {
  return resolveDispatcher().useLayoutEffect(create, inputs);
};
React.useMemo = function(create, inputs) {
  return resolveDispatcher().useMemo(create, inputs);
};
React.useMutationEffect = function(create, inputs) {
  return resolveDispatcher().useMutationEffect(create, inputs);
};
React.useReducer = function(reducer, initialState, initialAction) {
  return resolveDispatcher().useReducer(reducer, initialState, initialAction);
};
