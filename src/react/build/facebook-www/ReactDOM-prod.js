...
function completeRoot(root, finishedWork, expirationTime) {
  ...
  prevProps = currentRef.selectionRange;
  if (
    ...
    null !== prevProps &&
      ...
      ((current$$1$jscomp$0 = prevProps.start),
      (currentRef = prevProps.end),
      ...
      "selectionStart" in effectTag
        ...
        : ((currentRef =
          ...
          currentRef.getSelection &&
            ...
            (prevState = effectTag.textContent.length),
            (current$$1 = Math.min(prevProps.start, prevState)),
            (prevProps =
              void 0 === prevProps.end
                ? current$$1
                : Math.min(prevProps.end, prevState)),
            !currentRef.extend &&
              current$$1 > prevProps &&
              ((prevState = prevProps),
              (prevProps = current$$1),
            ...
            (instance = getNodeForCharacterOffset(effectTag, prevProps)),
            prevState &&
              instance &&
              (1 !== currentRef.rangeCount ||
                currentRef.anchorNode !== prevState.node ||
                currentRef.anchorOffset !== prevState.offset ||
                currentRef.focusNode !== instance.node ||
                currentRef.focusOffset !== instance.offset) &&
              ((current$$1$jscomp$0 = current$$1$jscomp$0.createRange()),
              current$$1$jscomp$0.setStart(prevState.node, prevState.offset),
              currentRef.removeAllRanges(),
              current$$1 > prevProps
                ? (currentRef.addRange(current$$1$jscomp$0),
                  currentRef.extend(instance.node, instance.offset))
                : (current$$1$jscomp$0.setEnd(instance.node, instance.offset),
                  currentRef.addRange(current$$1$jscomp$0))))));
    current$$1$jscomp$0 = [];
        ...
        if (effectTag$jscomp$0 & 36) {
          ...
          switch (prevProps.tag) {
            ...
            case 1:
              ...
              if (prevProps.effectTag & 4) {
                if (null === current$$1$jscomp$1)
                  startPhaseTimer(prevProps, "componentDidMount"),
                  ...
                  startPhaseTimer(prevProps, "componentDidUpdate");
            ...
            case 3:
              ...
              break;
            case 5:
              var _instance2 = prevProps.stateNode;
              null === current$$1$jscomp$1 &&
                prevProps.effectTag & 4 &&
