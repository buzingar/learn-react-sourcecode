...
var enableHooks = require("ReactFeatureFlags").enableHooks;
new Set();
var valueStack = [],
  index = -1;
function pop(cursor) {
...
var Dispatcher = {
  ...
  DispatcherWithoutHooks = { readContext: readContext },
...
function commitAllLifeCycles(
  ...
  for (; null !== nextEffect; ) {
    ...
    enableHooks &&
      effectTag & 512 &&
      (rootWithPendingPassiveEffects = finishedRoot$jscomp$0);
    nextEffect = nextEffect.nextEffect;
  }
}
...
function renderRoot(root, isYieldy) {
  ...
  flushPassiveEffects();
  isWorking = !0;
  ReactCurrentOwner$2.currentDispatcher = enableHooks
    ? Dispatcher
